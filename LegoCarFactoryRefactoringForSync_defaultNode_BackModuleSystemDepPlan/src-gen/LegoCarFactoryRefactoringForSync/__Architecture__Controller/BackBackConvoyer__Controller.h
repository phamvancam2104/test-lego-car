...
#ifndef LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_BACKBACKCONVOYER__CONTROLLER_H
#define LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_BACKBACKCONVOYER__CONTROLLER_H

/************************************************************
 BackBackConvoyer__Controller class header
 ************************************************************/
...
#define BACKBACKCONVOYER__CONTROLLER_TIME_EVENT_LOWER_BOUND (0)
#define BACKBACKCONVOYER__CONTROLLER_CHANGE_EVENT_LOWER_BOUND (0)
#define BACKBACKCONVOYER__CONTROLLER_TE_INDEX(id) (id - BACKBACKCONVOYER__CONTROLLER_TIME_EVENT_LOWER_BOUND)
#define BACKBACKCONVOYER__CONTROLLER_CHE_INDEX(id) (id - BACKBACKCONVOYER__CONTROLLER_CHANGE_EVENT_LOWER_BOUND)
...
#define BackBackConvoyer__Controller_THREAD_CREATE(thThread, str) pthread_create(&thThread, NULL, &BackBackConvoyer__Controller::thread_func_wrapper, &str);
#define BACKBACKCONVOYER__CONTROLLER_GET_CONTROL /*mutex synchronization to protect run-to-completion semantics*/ \
		while (!dispatchFlag) {} \
...
#define BACKBACKCONVOYER__CONTROLLER_RELEASE_CONTROL systemState = statemachine::IDLE; pthread_cond_signal(&runToCompletionCond); \
 ...
 * 
 */
class BackBackConvoyer__Controller: public IPush<
...
public:
	...
	typedef struct State_t {
		...
		//void (BackBackConvoyer__Controller::*entry)();
		//void (BackBackConvoyer__Controller::*exit)();
		//void (BackBackConvoyer__Controller::*doActivity)();
		State_t() {
			hasDoActivity = false;
			//entry = &BackBackConvoyer__Controller::entry_dft;
			//exit = &BackBackConvoyer__Controller::exit_dft;
			//doActivity = &BackBackConvoyer__Controller::doActivity_dft;
			for (int i = 0; i < 1; i++) {
	 ...
	 * 
	 */
	typedef void (BackBackConvoyer__Controller::*FptPointer)();
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::BackBackConvoyer__Controller::State_t states[11];
	/**
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::BackBackConvoyer__Controller::StateIDEnum activeStateID;
	/**
	 * 
	 */
...
private:
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Back::BackConvoyer* p_origin;
};
/************************************************************/
...
/************************************************************
 End of BackBackConvoyer__Controller class header
 ************************************************************/
