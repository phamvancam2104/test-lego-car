...
#define LegoCarFactoryRefactoringForSync___Architecture__Delegatee_Back_BackControlComponent__Delegatee_BODY

/************************************************************
 BackControlComponent__Delegatee class body
 ************************************************************/
 ...
 * 
 */
void BackControlComponent__Delegatee::dispatchEvent() {
	...
	while (systemState != statemachine::STOPPED) {
		...
		if (currentEvent != NULL) {
			BACKCONTROLCOMPONENT__DELEGATEE_GET_CONTROL
			...
			BACKCONTROLCOMPONENT__DELEGATEE_RELEASE_CONTROL
		}
	}
}
 ...
 * @param enter_mode 
 */
void BackControlComponent__Delegatee::BackControlStateMachine_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * @param enter_mode 
 */
void BackControlComponent__Delegatee::PrincipalState_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void BackControlComponent__Delegatee::PrincipalState_Region1_Exit() {
 ...
 * @param enter_mode 
 */
void BackControlComponent__Delegatee::EmnergencyStopState_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void BackControlComponent__Delegatee::EmnergencyStopState_Region1_Exit() {
	//exiting region Region1
 ...
 * @param enter_mode 
 */
void BackControlComponent__Delegatee::PrincipalState_Region2_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void BackControlComponent__Delegatee::PrincipalState_Region2_Exit() {
 ...
 * 
 */
BackControlComponent__Delegatee::BackControlComponent__Delegatee() :
		systemState(statemachine::IDLE) {
	//startBehavior();
}
 ...
 * 
 */
void BackControlComponent__Delegatee::startBehavior() {
	...
	for (int i = 0; i < (int) STATE_MAX; i++) {
		if (states[i].hasDoActivity) {
			...
			pthread_create(&threads[i], NULL,
					&BackControlComponent__Delegatee::thread_func_wrapper,
					&threadStructs[i]);
		}
	}

	timeEventThreadStructs[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
			TE_50_MS__ID)].duration = 50;
	for (int i = BACKCONTROLCOMPONENT__DELEGATEE_TIME_EVENT_LOWER_BOUND; i < 1;
			i++) {
		timeEventThreadStructs[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)].id =
				i;
		timeEventThreadStructs[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)].ptr =
				this;
		timeEventThreadStructs[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)].func_type =
				statemachine::TF_TIME_EVENT;
		timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)] =
				PTHREAD_MUTEX_INITIALIZER;
		timeEventConds[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)] =
				PTHREAD_COND_INITIALIZER;
		pthread_create(
				&timeEventThreads[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)],
				NULL, &BackControlComponent__Delegatee::thread_func_wrapper,
				&timeEventThreadStructs[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
						i)]);
		while (timeEventFlags[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)]) {
		}
	}

	regionTable[BACKCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION1] =
			&BackControlComponent__Delegatee::PrincipalState_Region1_Enter;
	regionExitTable[BACKCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION1] =
			&BackControlComponent__Delegatee::PrincipalState_Region1_Exit;
	regionTable[BACKCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION2] =
			&BackControlComponent__Delegatee::PrincipalState_Region2_Enter;
	regionExitTable[BACKCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION2] =
			&BackControlComponent__Delegatee::PrincipalState_Region2_Exit;
	...
	BackControlComponent__Delegatee_THREAD_CREATE(dispatchThread,
			dispatchStruct)
}
 ...
 * 
 */
void BackControlComponent__Delegatee::stopBehavior() {
	...
	for (int i = BACKCONTROLCOMPONENT__DELEGATEE_TIME_EVENT_LOWER_BOUND; i < 1;
			i++) {
		pthread_cond_signal (&timeEventConds[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
				i)]);
		pthread_join(
				timeEventThreads[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(i)],
				NULL);
 ...
 * @param sig 
 */
void BackControlComponent__Delegatee::processErrorDetection(
 ...
 * @param sig 
 */
void BackControlComponent__Delegatee::push(
		::CarFactoryLibrary::events::ErrorDetection& /*in*/sig) {
 ...
 * @param sig 
 */
void BackControlComponent__Delegatee::processEndOfModule(
 ...
 * 
 */
void BackControlComponent__Delegatee::processTE_50_ms_() {
	systemState = statemachine::EVENT_PROCESSING;
}
 ...
 * 
 */
void BackControlComponent__Delegatee::processCompletionEvent() {
	systemState = statemachine::EVENT_PROCESSING;
	...
	if (states[PRINCIPALSTATE_ID].actives[1] == CHECKMESSAGE_ID
		...
		if (true) {
			...
			if (choice_CompletionEvent == 0) {
				...
				BackControlComponent__Delegatee_THREAD_CREATE(
 ...
 * @param id 
 */
void BackControlComponent__Delegatee::StateEntry(unsigned int /*in*/id) {
	switch (id) {
	case INITIALIZATION_ID:
		component->init();
		break;
 ...
 * @param id 
 */
void BackControlComponent__Delegatee::StateExit(unsigned int /*in*/id) {
	switch (id) {
	default:
		//do nothing
		break;
 ...
 * @param id 
 */
void BackControlComponent__Delegatee::StateDoActivity(unsigned int /*in*/id) {
	switch (id) {
	case CHECK_ID:
 ...
 * @return ret 
 */
void* BackControlComponent__Delegatee::thread_func_wrapper(void* /*in*/data) {
	statemachine::StructForThread_t* cptr =
			(statemachine::StructForThread_t*) data;
	BackControlComponent__Delegatee* ptr =
			(BackControlComponent__Delegatee*) cptr->ptr;
 ...
 * @param id 
 */
void BackControlComponent__Delegatee::doCallActivity(int /*in*/id) {
	flags[id] = false;
	while (systemState != statemachine::STOPPED) {
 ...
 * @param value 
 */
void BackControlComponent__Delegatee::setFlag(int /*in*/id,
		char /*in*/func_type, bool /*in*/value) {
	//value = true => start activity
	//value = false => stop activity
	if (func_type == statemachine::TF_TIME_EVENT) {
		pthread_mutex_lock (&timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
				id)]);
		timeEventFlags[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id)] = value;
		pthread_cond_signal (&timeEventConds[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
				id)]);
		pthread_mutex_unlock(
				&timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id)]);
		return;
	}
 ...
 * @param duration 
 */
void BackControlComponent__Delegatee::listenTimeEvent(int /*in*/id,
		int /*in*/duration) {
	struct timeval tv;
	struct timespec ts;
	...
	while (systemState != statemachine::STOPPED) {
		pthread_mutex_lock (&timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
				id)]);
		while (!timeEventFlags[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id)]
				&& systemState != statemachine::STOPPED) {
			pthread_cond_wait(
					&timeEventConds[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id)],
					&timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
							id)]);
		}
		...
		if (systemState != statemachine::STOPPED) {
			timedWaitResult =
					pthread_cond_timedwait(
							&timeEventConds[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
									id)],
							&timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
									id)], &ts);
		}
		...
		timeEventFlags[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id)] = false;
		pthread_cond_signal (&timeEventConds[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(
				id)]);
		pthread_mutex_unlock(
				&timeEventMutexes[BACKCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id)]);
 ...
 * @param enter_mode 
 */
void BackControlComponent__Delegatee::regionCall(int /*in*/id,
		char /*in*/enter_mode) {
 ...
 * @param id 
 */
void BackControlComponent__Delegatee::exitRegionCall(int /*in*/id) {
 ...
 * @param comp 
 */
void BackControlComponent__Delegatee::setComponent(
 ...
 * @return ret 
 */
IPush<CarFactoryLibrary::events::ErrorDetection>* BackControlComponent__Delegatee::get_pErrDetect() {
 ...
 * @return ret 
 */
IPush<CarFactoryLibrary::events::EndOfModule>* BackControlComponent__Delegatee::get_pEndOfMo() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::Interfaces::EV3Brick::ILcd* BackControlComponent__Delegatee::get_pLCD() {
 ...
 * @return ret 
 */
::CarFactoryLibrary::IModule* BackControlComponent__Delegatee::get_pModule() {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutStopProcess_Shelf(
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutStopProcess_RoboticArm(
		IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pStopProcess_Convoyer(
		IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutRestart_Shelf(
		IPush<
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutRestart_Convoyer(
		IPush<
				LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutRestart_Robotic(
		IPush<
				LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pPrepare(
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pFloatMotor(
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pLargeMotorConvoyer(
		::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor* /*in*/ref) {
	component->pLargeMotorConvoyer.requiredIntf = ref;
}
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pLargeMotorPress(
		::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor* /*in*/ref) {
	component->pLargeMotorPress.requiredIntf = ref;
}
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutStopProcess_Press(
		IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutRestart_Press(
		IPush<
				LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutDelivered(
 ...
 * @param ref 
 */
void BackControlComponent__Delegatee::connect_pOutCheckRack(
...
/************************************************************
 End of BackControlComponent__Delegatee class body
 ************************************************************/
