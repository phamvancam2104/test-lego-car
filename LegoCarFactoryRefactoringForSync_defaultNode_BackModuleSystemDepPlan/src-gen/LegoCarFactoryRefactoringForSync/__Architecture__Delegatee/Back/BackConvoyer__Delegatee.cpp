...
#define LegoCarFactoryRefactoringForSync___Architecture__Delegatee_Back_BackConvoyer__Delegatee_BODY

/************************************************************
 BackConvoyer__Delegatee class body
 ************************************************************/
 ...
 * 
 */
void BackConvoyer__Delegatee::dispatchEvent() {
	...
	while (systemState != statemachine::STOPPED) {
		...
		if (currentEvent != NULL) {
			BACKCONVOYER__DELEGATEE_GET_CONTROL
			...
			BACKCONVOYER__DELEGATEE_RELEASE_CONTROL
		}
	}
}
 ...
 * @param enter_mode 
 */
void BackConvoyer__Delegatee::BackConveyorStateMachine_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * @param enter_mode 
 */
void BackConvoyer__Delegatee::PrincipalState_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void BackConvoyer__Delegatee::PrincipalState_Region1_Exit() {
 ...
 * 
 */
BackConvoyer__Delegatee::BackConvoyer__Delegatee() :
		systemState(statemachine::IDLE) {
	//startBehavior();
}
 ...
 * 
 */
void BackConvoyer__Delegatee::startBehavior() {
	...
	for (int i = 0; i < (int) STATE_MAX; i++) {
		if (states[i].hasDoActivity) {
			...
			pthread_create(&threads[i], NULL,
					&BackConvoyer__Delegatee::thread_func_wrapper,
					&threadStructs[i]);
		}
	}
	...
	BackConvoyer__Delegatee_THREAD_CREATE(dispatchThread, dispatchStruct)
}
 ...
 * 
 */
void BackConvoyer__Delegatee::stopBehavior() {
 ...
 * @param sig 
 */
void BackConvoyer__Delegatee::processRestartAfterEmergencyStop(
 ...
 * @param sig 
 */
void BackConvoyer__Delegatee::push(
		::LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop& /*in*/sig) {
 ...
 * @param sig 
 */
void BackConvoyer__Delegatee::processDeliveredCarConveyor(
 ...
 * @param sig 
 */
void BackConvoyer__Delegatee::processPrepareConveyor(
 ...
 * @param sig 
 */
void BackConvoyer__Delegatee::processGoToPress(
 ...
 * @param sig 
 */
void BackConvoyer__Delegatee::processStopProcess(
 ...
 * 
 */
void BackConvoyer__Delegatee::processCompletionEvent() {
	systemState = statemachine::EVENT_PROCESSING;
 ...
 * @param id 
 */
void BackConvoyer__Delegatee::StateEntry(unsigned int /*in*/id) {
	switch (id) {
	case MOVEFORWARD_ID:
		component->move_forward();
		break;
	case GOWAITPOSITION_ID:
		component->Entry_go_wait_position();
		break;
 ...
 * @param id 
 */
void BackConvoyer__Delegatee::StateExit(unsigned int /*in*/id) {
	switch (id) {
	default:
		//do nothing
		break;
 ...
 * @param id 
 */
void BackConvoyer__Delegatee::StateDoActivity(unsigned int /*in*/id) {
	switch (id) {
 ...
 * @return ret 
 */
void* BackConvoyer__Delegatee::thread_func_wrapper(void* /*in*/data) {
	statemachine::StructForThread_t* cptr =
			(statemachine::StructForThread_t*) data;
	BackConvoyer__Delegatee* ptr = (BackConvoyer__Delegatee*) cptr->ptr;
 ...
 * @param id 
 */
void BackConvoyer__Delegatee::doCallActivity(int /*in*/id) {
	flags[id] = false;
	while (systemState != statemachine::STOPPED) {
 ...
 * @param value 
 */
void BackConvoyer__Delegatee::setFlag(int /*in*/id, char /*in*/func_type,
		bool /*in*/value) {
 ...
 * @param comp 
 */
void BackConvoyer__Delegatee::setComponent(
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* BackConvoyer__Delegatee::get_pInStopProcess() {
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* BackConvoyer__Delegatee::get_pRestart() {
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::PrepareConveyor>* BackConvoyer__Delegatee::get_pPrepare() {
 ...
 * @return ret 
 */
IPush<CarFactoryLibrary::events::DeliveredCarConveyor>* BackConvoyer__Delegatee::get_pDelivered() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor* BackConvoyer__Delegatee::get_pILargeMotor() {
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::GoToPress>* BackConvoyer__Delegatee::get_pGotoProcess() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::IColorSensor* BackConvoyer__Delegatee::get_sensor() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor* BackConvoyer__Delegatee::get_pMotor() {
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pCheckRack(
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pErrDetect(
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pEndOfMo_Control(
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pEndOfMo_Shelf(
		IPush<CarFactoryLibrary::events::EndOfModule>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pEndOfMo_Robotic(
		IPush<CarFactoryLibrary::events::EndOfModule>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pEndOfMo_Press(
		IPush<CarFactoryLibrary::events::EndOfModule>* /*in*/ref) {
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pOutPressAssemble(
		IPush<CarFactoryLibrary::events::PressAssemble>* /*in*/ref) {
	component->pOutPressAssemble.outIntf = ref;
}
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pLCD(
 ...
 * @param ref 
 */
void BackConvoyer__Delegatee::connect_pModule(
...
/************************************************************
 End of BackConvoyer__Delegatee class body
 ************************************************************/
