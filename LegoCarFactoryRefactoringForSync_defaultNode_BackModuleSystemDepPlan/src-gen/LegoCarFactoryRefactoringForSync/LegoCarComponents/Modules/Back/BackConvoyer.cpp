 ...
 * 
 */
BackConvoyer::BackConvoyer() :
		CarFactoryLibrary::Conveyor("outC", "in1"), backconvoyerController(this) {
}
 ...
 * @param sig 
 */
void BackConvoyer::effectFromPrincipalStatetoRestart(
