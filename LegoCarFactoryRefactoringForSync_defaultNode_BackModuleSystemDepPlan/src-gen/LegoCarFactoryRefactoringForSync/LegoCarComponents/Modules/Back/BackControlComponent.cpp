 ...
 */
BackControlComponent::BackControlComponent(): Module("in2", "lego-ev3-color", "lego-ev3-color", "lego-ev3-color",
 ...
 * @param sig 
 */
void BackControlComponent::effectFromEmnergencyStopStatetoMisplace(::CarFactoryLibrary::events::ErrorDetection& /*in*/ sig) {
