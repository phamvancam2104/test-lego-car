 ...
 */
class CppLargeMotor : 
public ::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor, 
public ::EV3PapyrusLibrary::AbstractClasses::Actuators::AbstractLargeMotor	
 {
	 ...
	 * @return  
	 */
	 void run_for_second(int /*in*/ power, int /*in*/ second, bool /*in*/ brake, bool /*in*/ invert_sens = false);
	/**
	 ...
	 * @return  
	 */
	 void run_for_degres(int /*in*/ power, int /*in*/ degres, bool /*in*/ brake, bool /*in*/ invert_sens = false);
	/**
	 ...
	 * @return  
	 */
	 void run_for_turn(int /*in*/ power, int /*in*/ nb_turn, bool /*in*/ brake, bool /*in*/ invert_sens = false);
	/**
	 ...
	 * @param portAdress 
	 */
	CppLargeMotor(::EV3PapyrusLibrary::Types::LocalString /*in*/ portAdress = "outA");
