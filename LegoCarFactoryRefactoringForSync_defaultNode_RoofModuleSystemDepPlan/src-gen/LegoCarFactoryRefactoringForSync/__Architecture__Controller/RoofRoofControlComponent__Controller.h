...
#ifndef LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_ROOFROOFCONTROLCOMPONENT__CONTROLLER_H
#define LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_ROOFROOFCONTROLCOMPONENT__CONTROLLER_H

/************************************************************
 RoofRoofControlComponent__Controller class header
 ************************************************************/
...
#define ROOFROOFCONTROLCOMPONENT__CONTROLLER_TIME_EVENT_LOWER_BOUND (0)
#define ROOFROOFCONTROLCOMPONENT__CONTROLLER_CHANGE_EVENT_LOWER_BOUND (1)
#define ROOFROOFCONTROLCOMPONENT__CONTROLLER_TE_INDEX(id) (id - ROOFROOFCONTROLCOMPONENT__CONTROLLER_TIME_EVENT_LOWER_BOUND)
#define ROOFROOFCONTROLCOMPONENT__CONTROLLER_CHE_INDEX(id) (id - ROOFROOFCONTROLCOMPONENT__CONTROLLER_CHANGE_EVENT_LOWER_BOUND)
...
#define RoofRoofControlComponent__Controller_THREAD_CREATE(thThread, str) pthread_create(&thThread, NULL, &RoofRoofControlComponent__Controller::thread_func_wrapper, &str);
#define ROOFROOFCONTROLCOMPONENT__CONTROLLER_GET_CONTROL /*mutex synchronization to protect run-to-completion semantics*/ \
		while (!dispatchFlag) {} \
...
#define ROOFROOFCONTROLCOMPONENT__CONTROLLER_RELEASE_CONTROL systemState = statemachine::IDLE; pthread_cond_signal(&runToCompletionCond); \
...
public:
	...
	typedef struct State_t {
		...
		//void (RoofRoofControlComponent__Controller::*entry)();
		//void (RoofRoofControlComponent__Controller::*exit)();
		//void (RoofRoofControlComponent__Controller::*doActivity)();
		State_t() {
			hasDoActivity = false;
			//entry = &RoofRoofControlComponent__Controller::entry_dft;
			//exit = &RoofRoofControlComponent__Controller::exit_dft;
			//doActivity = &RoofRoofControlComponent__Controller::doActivity_dft;
			for (int i = 0; i < 2; i++) {
	 ...
	 * 
	 */
	typedef void (RoofRoofControlComponent__Controller::*FptPointer)();

	/**
	 * 
	 */
	typedef void (RoofRoofControlComponent__Controller::*RegionFunctionPtr_t)(
			char enter_mode);
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofControlComponent__Controller::State_t states[16];
	/**
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofControlComponent__Controller::StateIDEnum activeStateID;
	/**
	 * 
	 */
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofControlComponent__Controller::FptPointer timeEventTable[1];
	/**
	 * 
	 */
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofControlComponent__Controller::RegionFunctionPtr_t regionTable[2];
	/**
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofControlComponent__Controller::FptPointer regionExitTable[2];
	/**
	 * 
	 */
	 ...
	 * @param origin 
	 */
	RoofRoofControlComponent__Controller(
...
private:
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Roof::RoofControlComponent* p_origin;
};
/************************************************************/
...
/************************************************************
 End of RoofRoofControlComponent__Controller class header
 ************************************************************/
