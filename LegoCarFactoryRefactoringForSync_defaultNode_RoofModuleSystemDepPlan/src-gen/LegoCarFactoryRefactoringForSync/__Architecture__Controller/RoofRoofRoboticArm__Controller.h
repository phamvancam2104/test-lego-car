...
#ifndef LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_ROOFROOFROBOTICARM__CONTROLLER_H
#define LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_ROOFROOFROBOTICARM__CONTROLLER_H

/************************************************************
 RoofRoofRoboticArm__Controller class header
 ************************************************************/
...
#define ROOFROOFROBOTICARM__CONTROLLER_TIME_EVENT_LOWER_BOUND (0)
#define ROOFROOFROBOTICARM__CONTROLLER_CHANGE_EVENT_LOWER_BOUND (0)
#define ROOFROOFROBOTICARM__CONTROLLER_TE_INDEX(id) (id - ROOFROOFROBOTICARM__CONTROLLER_TIME_EVENT_LOWER_BOUND)
#define ROOFROOFROBOTICARM__CONTROLLER_CHE_INDEX(id) (id - ROOFROOFROBOTICARM__CONTROLLER_CHANGE_EVENT_LOWER_BOUND)
...
#define RoofRoofRoboticArm__Controller_THREAD_CREATE(thThread, str) pthread_create(&thThread, NULL, &RoofRoofRoboticArm__Controller::thread_func_wrapper, &str);
#define ROOFROOFROBOTICARM__CONTROLLER_GET_CONTROL /*mutex synchronization to protect run-to-completion semantics*/ \
		while (!dispatchFlag) {} \
...
#define ROOFROOFROBOTICARM__CONTROLLER_RELEASE_CONTROL systemState = statemachine::IDLE; pthread_cond_signal(&runToCompletionCond); \
 ...
 * 
 */
class RoofRoofRoboticArm__Controller: public IPush<
...
public:
	...
	typedef struct State_t {
		...
		//void (RoofRoofRoboticArm__Controller::*entry)();
		//void (RoofRoofRoboticArm__Controller::*exit)();
		//void (RoofRoofRoboticArm__Controller::*doActivity)();
		State_t() {
			hasDoActivity = false;
			//entry = &RoofRoofRoboticArm__Controller::entry_dft;
			//exit = &RoofRoofRoboticArm__Controller::exit_dft;
			//doActivity = &RoofRoofRoboticArm__Controller::doActivity_dft;
			for (int i = 0; i < 1; i++) {
	 ...
	 * 
	 */
	typedef void (RoofRoofRoboticArm__Controller::*FptPointer)();
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofRoboticArm__Controller::State_t states[7];
	/**
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofRoboticArm__Controller::StateIDEnum activeStateID;
	/**
	 * 
	 */
	 ...
	 * @param origin 
	 */
	RoofRoofRoboticArm__Controller(
...
private:
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Roof::RoofRoboticArm* p_origin;
};
/************************************************************/
...
/************************************************************
 End of RoofRoofRoboticArm__Controller class header
 ************************************************************/
