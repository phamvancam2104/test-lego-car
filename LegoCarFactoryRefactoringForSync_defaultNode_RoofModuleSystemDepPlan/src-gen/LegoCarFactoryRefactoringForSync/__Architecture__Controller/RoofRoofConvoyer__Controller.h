...
#ifndef LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_ROOFROOFCONVOYER__CONTROLLER_H
#define LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_ROOFROOFCONVOYER__CONTROLLER_H

/************************************************************
 RoofRoofConvoyer__Controller class header
 ************************************************************/
...
#define ROOFROOFCONVOYER__CONTROLLER_TIME_EVENT_LOWER_BOUND (0)
#define ROOFROOFCONVOYER__CONTROLLER_CHANGE_EVENT_LOWER_BOUND (0)
#define ROOFROOFCONVOYER__CONTROLLER_TE_INDEX(id) (id - ROOFROOFCONVOYER__CONTROLLER_TIME_EVENT_LOWER_BOUND)
#define ROOFROOFCONVOYER__CONTROLLER_CHE_INDEX(id) (id - ROOFROOFCONVOYER__CONTROLLER_CHANGE_EVENT_LOWER_BOUND)
...
#define RoofRoofConvoyer__Controller_THREAD_CREATE(thThread, str) pthread_create(&thThread, NULL, &RoofRoofConvoyer__Controller::thread_func_wrapper, &str);
#define ROOFROOFCONVOYER__CONTROLLER_GET_CONTROL /*mutex synchronization to protect run-to-completion semantics*/ \
		while (!dispatchFlag) {} \
...
#define ROOFROOFCONVOYER__CONTROLLER_RELEASE_CONTROL systemState = statemachine::IDLE; pthread_cond_signal(&runToCompletionCond); \
 ...
 * 
 */
class RoofRoofConvoyer__Controller: public IPush<
...
public:
	...
	typedef struct State_t {
		...
		//void (RoofRoofConvoyer__Controller::*entry)();
		//void (RoofRoofConvoyer__Controller::*exit)();
		//void (RoofRoofConvoyer__Controller::*doActivity)();
		State_t() {
			hasDoActivity = false;
			//entry = &RoofRoofConvoyer__Controller::entry_dft;
			//exit = &RoofRoofConvoyer__Controller::exit_dft;
			//doActivity = &RoofRoofConvoyer__Controller::doActivity_dft;
			for (int i = 0; i < 1; i++) {
	 ...
	 * 
	 */
	typedef void (RoofRoofConvoyer__Controller::*FptPointer)();
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofConvoyer__Controller::State_t states[12];
	/**
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::RoofRoofConvoyer__Controller::StateIDEnum activeStateID;
	/**
	 * 
	 */
...
private:
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Roof::RoofConvoyer* p_origin;
};
/************************************************************/
...
/************************************************************
 End of RoofRoofConvoyer__Controller class header
 ************************************************************/
