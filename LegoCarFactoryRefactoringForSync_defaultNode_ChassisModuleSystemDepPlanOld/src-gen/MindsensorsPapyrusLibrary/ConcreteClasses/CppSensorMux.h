 ...
 */
class CppSensorMux : 
public ::MindsensorsPapyrusLibrary::Interfaces::ISensorMux, 
...
public ::EV3PapyrusLibrary::ConcreteClasses::ev3devCpp::EV3Brick::CppDevice	
 {
	 ...
	 * @param sensorTypes 
	 */
	CppSensorMux(::EV3PapyrusLibrary::Types::LocalString /*in*/ portAddress = "in1", ::MindsensorsPapyrusLibrary::Types::VectorLocalString /*in*/ sensorTypes = std::vector<EV3PapyrusLibrary::Types::LocalString>());
