...
class Shelf {
	 ...
	 */
	Shelf(int /*in*/ number_rack_sensor = 0, ::EV3PapyrusLibrary::Types::LocalString /*in*/ rack_sensorPort1 = "in1", ::EV3PapyrusLibrary::Types::LocalString /*in*/ rack_sensorPort2 = "in1", ::EV3PapyrusLibrary::Types::LocalString /*in*/ rack_sensorPort3 = "in1");
	/**
	 * 
	 * @return ret 
	 * @param sig 
