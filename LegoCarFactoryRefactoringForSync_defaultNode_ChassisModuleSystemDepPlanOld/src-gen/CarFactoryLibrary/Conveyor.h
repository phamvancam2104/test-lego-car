...
public:
	 ...
	 */
	Conveyor(::EV3PapyrusLibrary::Types::LocalString /*in*/motorPort = "outA",
			::EV3PapyrusLibrary::Types::LocalString /*in*/sensorPort = "in1",
			int /*in*/wait_offset = 0, int /*in*/check_presence_offset = 0,
			int /*in*/delivered_car_offset = 0);
	/**
	 * go to the position to wait the piece of the car
	 */
