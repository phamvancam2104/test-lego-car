...
#ifndef LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__DELEGATEE_CHASSIS_CHASSISCONTROLCOMPONENT__DELEGATEE_H
#define LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__DELEGATEE_CHASSIS_CHASSISCONTROLCOMPONENT__DELEGATEE_H

/************************************************************
              ChassisControlComponent__Delegatee class header
 ************************************************************/
...
#define CHASSISCONTROLCOMPONENT__DELEGATEE_TIME_EVENT_LOWER_BOUND (0)
#define CHASSISCONTROLCOMPONENT__DELEGATEE_CHANGE_EVENT_LOWER_BOUND (1)
#define CHASSISCONTROLCOMPONENT__DELEGATEE_TE_INDEX(id) (id - CHASSISCONTROLCOMPONENT__DELEGATEE_TIME_EVENT_LOWER_BOUND)
#define CHASSISCONTROLCOMPONENT__DELEGATEE_CHE_INDEX(id) (id - CHASSISCONTROLCOMPONENT__DELEGATEE_CHANGE_EVENT_LOWER_BOUND)
...
#undef CHECKPOINT
#endif
#define CHECKPOINT if (chassiscontrolcomponentController.systemState == statemachine::EVENT_PROCESSING || chassiscontrolcomponentController.systemState == statemachine::STOPPED) {return;}
#define ChassisControlComponent__Delegatee_THREAD_CREATE(thThread, str) pthread_create(&thThread, NULL, &ChassisControlComponent__Delegatee::thread_func_wrapper, &str);
#define CHASSISCONTROLCOMPONENT__DELEGATEE_GET_CONTROL /*mutex synchronization to protect run-to-completion semantics*/ \
		while (!dispatchFlag) {} \
...
#define CHASSISCONTROLCOMPONENT__DELEGATEE_RELEASE_CONTROL systemState = statemachine::IDLE; pthread_cond_signal(&runToCompletionCond); \
...
namespace LegoCarFactoryRefactoringForSync {namespace LegoCarComponents {namespace Modules {namespace Chassis {class ChassisControlComponent;}}}}
namespace LegoCarFactoryRefactoringForSync {namespace signals {class StopProcess;}}
 ...
 * 
 */
class ChassisControlComponent__Delegatee : 
...
public ::statemachine::EventQueueAllocationConfiguration	
 {
    ...
    typedef struct State_t {
    	...
    	//void (ChassisControlComponent__Delegatee::*entry)();
    	//void (ChassisControlComponent__Delegatee::*exit)();
    	//void (ChassisControlComponent__Delegatee::*doActivity)();
    	State_t() {
    		hasDoActivity = false;
    		//entry = &ChassisControlComponent__Delegatee::entry_dft;
    		//exit = &ChassisControlComponent__Delegatee::exit_dft;
    		//doActivity = &ChassisControlComponent__Delegatee::doActivity_dft;
    		for(int i = 0; i < 1; i++) {
     ...
     * 
     */
    typedef void (ChassisControlComponent__Delegatee::*FptPointer)()
    	;
	 ...
	 * 
	 */
	 ::LegoCarFactoryRefactoringForSync::__Architecture__Delegatee::Chassis::ChassisControlComponent__Delegatee::State_t states[12];
	/**
	 * 
	 */
	 ::LegoCarFactoryRefactoringForSync::__Architecture__Delegatee::Chassis::ChassisControlComponent__Delegatee::StateIDEnum activeStateID;
	/**
	 * 
	 */
	 bool dispatchFlag;
	 ...
	 * 
	 */
	 int choice13_CompletionEvent;
	/**
	 * 
	 */
	 int choice5_CompletionEvent;
	/**
	 * 
	 */
	 int choice4_CompletionEvent;
	/**
	 * 
	 */
	 ...
	 * 
	 */
	 ::LegoCarFactoryRefactoringForSync::__Architecture__Delegatee::Chassis::ChassisControlComponent__Delegatee::FptPointer timeEventTable[1];
	/**
	 * 
	 */
	 ...
	 * 
	 */
	ChassisControlComponent__Delegatee();
	/**
	 * 
	 */
	void startBehavior();
	 ...
	 * @param sig 
	 */
	void processErrorDetection(::CarFactoryLibrary::events::ErrorDetection& /*in*/ sig);
	/**
	 * 
	 * @param sig 
	 */
	 ...
	 * @param comp 
	 */
	void setComponent(::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Chassis::ChassisControlComponent* /*in*/ comp);
	/**
	 * 
	 * @return ret 
	 */
	 ...
	 * @param ref 
	 */
	virtual void connect_pOutStopProcess_Shelf(IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ ref);
	/**
	 * 
	 * @param ref 
	 */
	virtual void connect_pOutStopProcess_RoboticArm(IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ ref);
	/**
	 * 
	 * @param ref 
	 */
	virtual void connect_pOutRestart_Shelf(IPush<LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ ref);
	/**
	 * 
	 * @param ref 
	 */
	virtual void connect_pOutRestart_Convoyer(IPush<LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ ref);
	/**
	 * 
	 * @param ref 
	 */
	virtual void connect_pPrepare(IPush<LegoCarFactoryRefactoringForSync::signals::PrepareConveyor>* /*in*/ ref);
	/**
	 * 
	 * @param ref 
	 */
	virtual void connect_pOutRestart_Robotic(IPush<LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ ref);
	 ...
	 * 
	 */
	 ::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Chassis::ChassisControlComponent* component;
};
/************************************************************/
...
/************************************************************
              End of ChassisControlComponent__Delegatee class header
 ************************************************************/
