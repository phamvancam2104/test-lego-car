...
namespace EV3PapyrusLibrary {namespace ConcreteClasses {namespace ev3devCpp {namespace Sensors {class CppTouchSensor;}}}}
...
class CppTouchSensor__Delegatee {
	 ...
	 * @param comp 
	 */
	void setComponent(::EV3PapyrusLibrary::ConcreteClasses::ev3devCpp::Sensors::CppTouchSensor* /*in*/ comp);
	/**
	 * 
	 */
