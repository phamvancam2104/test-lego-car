...
public IEV3Brick	
 {
	public:
	AbstractEV3Brick() : leftGreenLed("ev3-left1:green:ev3dev"), rightGreenLed("ev3-right1:green:ev3dev"), leftRedLed("ev3-left0:red:ev3dev"), rightRedLed("ev3-right0:red:ev3dev"), backButton(KEY_BACKSPACE), leftButton(KEY_LEFT), rightButton(KEY_RIGHT), topButton(KEY_UP), downButton(KEY_DOWN), okButton(KEY_ENTER), bluetoothDevice("useless") {}
	/**
	 * 
	 */
