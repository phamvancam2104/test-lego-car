...
#define LegoCarFactoryRefactoringForSync___Architecture__Controller_FrontFrontControlComponent__Controller_BODY

/************************************************************
 FrontFrontControlComponent__Controller class body
 ************************************************************/
 ...
 * 
 */
void FrontFrontControlComponent__Controller::dispatchEvent() {
	...
	while (systemState != statemachine::STOPPED) {
		...
		if (currentEvent != NULL) {
			...
			FRONTFRONTCONTROLCOMPONENT__CONTROLLER_RELEASE_CONTROL
		}
	}
}
 ...
 * @param enter_mode 
 */
void FrontFrontControlComponent__Controller::FrontControlStateMachine_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * @param enter_mode 
 */
void FrontFrontControlComponent__Controller::PrincipalState_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void FrontFrontControlComponent__Controller::PrincipalState_Region1_Exit() {
 ...
 * @param enter_mode 
 */
void FrontFrontControlComponent__Controller::EmnergencyStopState_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void FrontFrontControlComponent__Controller::EmnergencyStopState_Region1_Exit() {
	//exiting region Region1
 ...
 * @param enter_mode 
 */
void FrontFrontControlComponent__Controller::PrincipalState_Region2_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void FrontFrontControlComponent__Controller::PrincipalState_Region2_Exit() {
 ...
 * @param origin 
 */
FrontFrontControlComponent__Controller::FrontFrontControlComponent__Controller(
 ...
 * 
 */
void FrontFrontControlComponent__Controller::startBehavior() {
	systemState = statemachine::IDLE;
	...
	for (int i = 0; i < (int) STATE_MAX; i++) {
		if (states[i].hasDoActivity) {
			...
			pthread_create(&threads[i], NULL,
					&FrontFrontControlComponent__Controller::thread_func_wrapper,
					&threadStructs[i]);
		}
	}

	timeEventThreadStructs[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
			TE_50_MS__ID)].duration = 50;
	for (int i = FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TIME_EVENT_LOWER_BOUND;
			i < 1; i++) {
		timeEventThreadStructs[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
				i)].id = i;
		timeEventThreadStructs[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
		...
		timeEventMutexes[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(i)] =
				PTHREAD_MUTEX_INITIALIZER;
		timeEventConds[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(i)] =
				PTHREAD_COND_INITIALIZER;
		pthread_create(
				&timeEventThreads[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
						i)], NULL,
				&FrontFrontControlComponent__Controller::thread_func_wrapper,
				&timeEventThreadStructs[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
						i)]);
		while (timeEventFlags[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(i)]) {
		}
	}

	regionTable[FRONTCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION1] =
			&FrontFrontControlComponent__Controller::PrincipalState_Region1_Enter;
	regionExitTable[FRONTCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION1] =
			&FrontFrontControlComponent__Controller::PrincipalState_Region1_Exit;
	regionTable[FRONTCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION2] =
			&FrontFrontControlComponent__Controller::PrincipalState_Region2_Enter;
	regionExitTable[FRONTCONTROLCOMPONENT_REGION_ID_PRINCIPALSTATE_REGION2] =
			&FrontFrontControlComponent__Controller::PrincipalState_Region2_Exit;
	...
	FrontFrontControlComponent__Controller_THREAD_CREATE(dispatchThread,
			dispatchStruct)
}
 ...
 * 
 */
void FrontFrontControlComponent__Controller::stopBehavior() {
	...
	for (int i = FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TIME_EVENT_LOWER_BOUND;
			i < 1; i++) {
		pthread_cond_signal (&timeEventConds[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
				i)]);
		pthread_join(
				timeEventThreads[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
						i)], NULL);
 ...
 * @param sig 
 */
void FrontFrontControlComponent__Controller::processEndOfModule(
 ...
 * 
 */
void FrontFrontControlComponent__Controller::processCompletionEvent() {
	systemState = statemachine::EVENT_PROCESSING;
	...
	if (states[PRINCIPALSTATE_ID].actives[1] == CHECKMESSAGE_ID
		...
		if (true) {
			...
			if (p_origin->fromChoicetoPingGuard()) {
				...
				FrontFrontControlComponent__Controller_THREAD_CREATE(
 ...
 * @param id 
 */
void FrontFrontControlComponent__Controller::StateEntry(unsigned int /*in*/id) {
	switch (id) {
	case INITIALIZATION_ID:
		p_origin->init();
		break;
 ...
 * @param id 
 */
void FrontFrontControlComponent__Controller::StateExit(unsigned int /*in*/id) {
	switch (id) {
	default:
		//do nothing
		break;
 ...
 * @param id 
 */
void FrontFrontControlComponent__Controller::StateDoActivity(
		unsigned int /*in*/id) {
	switch (id) {
	case CHECK_ID:
 ...
 * @return ret 
 */
void* FrontFrontControlComponent__Controller::thread_func_wrapper(
		void* /*in*/data) {
	statemachine::StructForThread_t* cptr =
			(statemachine::StructForThread_t*) data;
	FrontFrontControlComponent__Controller* ptr =
			(FrontFrontControlComponent__Controller*) cptr->ptr;
 ...
 * @param id 
 */
void FrontFrontControlComponent__Controller::doCallActivity(int /*in*/id) {
	flags[id] = false;
	while (systemState != statemachine::STOPPED) {
 ...
 * @param value 
 */
void FrontFrontControlComponent__Controller::setFlag(int /*in*/id,
		char /*in*/func_type, bool /*in*/value) {
	//value = true => start activity
	//value = false => stop activity
	if (func_type == statemachine::TF_TIME_EVENT) {
		pthread_mutex_lock (&timeEventMutexes[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
				id)]);
		timeEventFlags[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(id)] =
				value;
		pthread_cond_signal (&timeEventConds[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
				id)]);
		pthread_mutex_unlock(
				&timeEventMutexes[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
						id)]);
		return;
	}
 ...
 * @param duration 
 */
void FrontFrontControlComponent__Controller::listenTimeEvent(int /*in*/id,
		int /*in*/duration) {
	struct timeval tv;
	struct timespec ts;
	...
	while (systemState != statemachine::STOPPED) {
		pthread_mutex_lock (&timeEventMutexes[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
				id)]);
		while (!timeEventFlags[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
				id)] && systemState != statemachine::STOPPED) {
			pthread_cond_wait(
					&timeEventConds[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
							id)],
					&timeEventMutexes[FRONTFRONTCONTROLCOMPONENT__CONTROLLER_TE_INDEX(
							id)]);
		}
 ...
 * @param enter_mode 
 */
void FrontFrontControlComponent__Controller::regionCall(int /*in*/id,
		char /*in*/enter_mode) {
 ...
 * @param id 
 */
void FrontFrontControlComponent__Controller::exitRegionCall(int /*in*/id) {
 ...
 * @return ret 
 */
IPush<CarFactoryLibrary::events::ErrorDetection>* FrontFrontControlComponent__Controller::get_pErrDetect() {
 ...
 * @return ret 
 */
IPush<CarFactoryLibrary::events::EndOfModule>* FrontFrontControlComponent__Controller::get_pEndOfMo() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::Interfaces::EV3Brick::ILcd* FrontFrontControlComponent__Controller::get_pLCD() {
 ...
 * @return ret 
 */
::CarFactoryLibrary::IModule* FrontFrontControlComponent__Controller::get_pModule() {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutStopProcess_Shelf(
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutStopProcess_RoboticArm(
		IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pStopProcess_Convoyer(
		IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutRestart_Shelf(
		IPush<
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutRestart_Convoyer(
		IPush<
				LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutRestart_Robotic(
		IPush<
				LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pPrepare(
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutStopProcess_Press(
		IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pOutRestart_Press(
		IPush<
				LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontFrontControlComponent__Controller::connect_pCheckRack(
...
/************************************************************
 End of FrontFrontControlComponent__Controller class body
 ************************************************************/
