...
#ifndef LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_SLAVESSLAVEPRESS__CONTROLLER_H
#define LEGOCARFACTORYREFACTORINGFORSYNC___ARCHITECTURE__CONTROLLER_SLAVESSLAVEPRESS__CONTROLLER_H

/************************************************************
 SlavesSlavePress__Controller class header
 ************************************************************/
...
#define SLAVESSLAVEPRESS__CONTROLLER_TIME_EVENT_LOWER_BOUND (0)
#define SLAVESSLAVEPRESS__CONTROLLER_CHANGE_EVENT_LOWER_BOUND (0)
#define SLAVESSLAVEPRESS__CONTROLLER_TE_INDEX(id) (id - SLAVESSLAVEPRESS__CONTROLLER_TIME_EVENT_LOWER_BOUND)
#define SLAVESSLAVEPRESS__CONTROLLER_CHE_INDEX(id) (id - SLAVESSLAVEPRESS__CONTROLLER_CHANGE_EVENT_LOWER_BOUND)
...
#define SlavesSlavePress__Controller_THREAD_CREATE(thThread, str) pthread_create(&thThread, NULL, &SlavesSlavePress__Controller::thread_func_wrapper, &str);
#define SLAVESSLAVEPRESS__CONTROLLER_GET_CONTROL /*mutex synchronization to protect run-to-completion semantics*/ \
		while (!dispatchFlag) {} \
...
#define SLAVESSLAVEPRESS__CONTROLLER_RELEASE_CONTROL systemState = statemachine::IDLE; pthread_cond_signal(&runToCompletionCond); \
...
public:
	...
	typedef struct State_t {
		...
		//void (SlavesSlavePress__Controller::*entry)();
		//void (SlavesSlavePress__Controller::*exit)();
		//void (SlavesSlavePress__Controller::*doActivity)();
		State_t() {
			hasDoActivity = false;
			//entry = &SlavesSlavePress__Controller::entry_dft;
			//exit = &SlavesSlavePress__Controller::exit_dft;
			//doActivity = &SlavesSlavePress__Controller::doActivity_dft;
			for (int i = 0; i < 1; i++) {
	 ...
	 * 
	 */
	typedef void (SlavesSlavePress__Controller::*FptPointer)();
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::SlavesSlavePress__Controller::State_t states[7];
	/**
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::__Architecture__Controller::SlavesSlavePress__Controller::StateIDEnum activeStateID;
	/**
	 * 
	 */
...
private:
	 ...
	 * 
	 */
	::LegoCarFactoryRefactoringForSync::LegoCarComponents::Modules::Slaves::SlavePress* p_origin;
};
/************************************************************/
...
/************************************************************
 End of SlavesSlavePress__Controller class header
 ************************************************************/
