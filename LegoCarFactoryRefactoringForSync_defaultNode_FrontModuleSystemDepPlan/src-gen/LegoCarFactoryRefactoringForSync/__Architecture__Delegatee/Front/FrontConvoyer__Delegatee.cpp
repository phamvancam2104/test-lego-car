...
#define LegoCarFactoryRefactoringForSync___Architecture__Delegatee_Front_FrontConvoyer__Delegatee_BODY

/************************************************************
 FrontConvoyer__Delegatee class body
 ************************************************************/

// include associated header file
#include "LegoCarFactoryRefactoringForSync/__Architecture__Delegatee/Front/FrontConvoyer__Delegatee.h"
 ...
 * 
 */
void FrontConvoyer__Delegatee::dispatchEvent() {
	...
	while (systemState != statemachine::STOPPED) {
		...
		if (currentEvent != NULL) {
			FRONTCONVOYER__DELEGATEE_GET_CONTROL
			...
			FRONTCONVOYER__DELEGATEE_RELEASE_CONTROL
		}
	}
}
 ...
 * @param enter_mode 
 */
void FrontConvoyer__Delegatee::FrontConveyorStateMachine_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * @param enter_mode 
 */
void FrontConvoyer__Delegatee::PrincipalState_Region1_Enter(
		char /*in*/enter_mode) {
	switch (enter_mode) {
 ...
 * 
 */
void FrontConvoyer__Delegatee::PrincipalState_Region1_Exit() {
 ...
 * 
 */
FrontConvoyer__Delegatee::FrontConvoyer__Delegatee() :
		systemState(statemachine::IDLE) {
	//startBehavior();
}
 ...
 * 
 */
void FrontConvoyer__Delegatee::startBehavior() {
	...
	for (int i = 0; i < (int) STATE_MAX; i++) {
		if (states[i].hasDoActivity) {
			...
			pthread_create(&threads[i], NULL,
					&FrontConvoyer__Delegatee::thread_func_wrapper,
					&threadStructs[i]);
		}
	}
	...
	FrontConvoyer__Delegatee_THREAD_CREATE(dispatchThread, dispatchStruct)
}
 ...
 * 
 */
void FrontConvoyer__Delegatee::stopBehavior() {
 ...
 * @param sig 
 */
void FrontConvoyer__Delegatee::processStopProcess(
 ...
 * @param sig 
 */
void FrontConvoyer__Delegatee::push(
		::LegoCarFactoryRefactoringForSync::signals::StopProcess& /*in*/sig) {
 ...
 * @param sig 
 */
void FrontConvoyer__Delegatee::processRestartAfterEmergencyStop(
 ...
 * @param sig 
 */
void FrontConvoyer__Delegatee::processGoToPress(
 ...
 * @param sig 
 */
void FrontConvoyer__Delegatee::processDeliveredCarConveyor(
 ...
 * @param sig 
 */
void FrontConvoyer__Delegatee::processPrepareConveyor(
 ...
 * 
 */
void FrontConvoyer__Delegatee::processCompletionEvent() {
	systemState = statemachine::EVENT_PROCESSING;
 ...
 * @param id 
 */
void FrontConvoyer__Delegatee::StateEntry(unsigned int /*in*/id) {
	switch (id) {
	case GOWAITPOSITION_ID:
		component->go_wait_position();
		break;
	case REPLACE_ID:
		component->replace();
		break;
 ...
 * @param id 
 */
void FrontConvoyer__Delegatee::StateExit(unsigned int /*in*/id) {
	switch (id) {
	default:
		//do nothing
		break;
 ...
 * @param id 
 */
void FrontConvoyer__Delegatee::StateDoActivity(unsigned int /*in*/id) {
	switch (id) {
 ...
 * @return ret 
 */
void* FrontConvoyer__Delegatee::thread_func_wrapper(void* /*in*/data) {
	statemachine::StructForThread_t* cptr =
			(statemachine::StructForThread_t*) data;
	FrontConvoyer__Delegatee* ptr = (FrontConvoyer__Delegatee*) cptr->ptr;
 ...
 * @param id 
 */
void FrontConvoyer__Delegatee::doCallActivity(int /*in*/id) {
	flags[id] = false;
	while (systemState != statemachine::STOPPED) {
 ...
 * @param value 
 */
void FrontConvoyer__Delegatee::setFlag(int /*in*/id, char /*in*/func_type,
		bool /*in*/value) {
 ...
 * @param comp 
 */
void FrontConvoyer__Delegatee::setComponent(
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::StopProcess>* FrontConvoyer__Delegatee::get_pInStopProcess() {
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::RestartAfterEmergencyStop>* FrontConvoyer__Delegatee::get_pRestart() {
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::PrepareConveyor>* FrontConvoyer__Delegatee::get_pPrepare() {
 ...
 * @return ret 
 */
IPush<CarFactoryLibrary::events::DeliveredCarConveyor>* FrontConvoyer__Delegatee::get_pDelivered() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor* FrontConvoyer__Delegatee::get_pILargeMotor() {
 ...
 * @return ret 
 */
IPush<LegoCarFactoryRefactoringForSync::signals::GoToPress>* FrontConvoyer__Delegatee::get_pGotoProcess() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::IColorSensor* FrontConvoyer__Delegatee::get_sensor() {
 ...
 * @return ret 
 */
::EV3PapyrusLibrary::Interfaces::Actuators::ILargeMotor* FrontConvoyer__Delegatee::get_pMotor() {
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pCheckRack(
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pErrDetect(
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pEndOfMo_Control(
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pEndOfMo_Shelf(
		IPush<CarFactoryLibrary::events::EndOfModule>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pEndOfMo_Robotic(
		IPush<CarFactoryLibrary::events::EndOfModule>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pEndOfMo_Press(
		IPush<CarFactoryLibrary::events::EndOfModule>* /*in*/ref) {
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pOutAssemble(
		IPush<CarFactoryLibrary::events::PressAssemble>* /*in*/ref) {
	component->pOutAssemble.outIntf = ref;
}
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pLCD(
 ...
 * @param ref 
 */
void FrontConvoyer__Delegatee::connect_pModule(
...
/************************************************************
 End of FrontConvoyer__Delegatee class body
 ************************************************************/
